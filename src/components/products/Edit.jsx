...
const Edit = () => {
  ...
  const columns = [
    ...
    //"record" ifadesi, tablodaki her bir satırdaki verilere erişmek için kullanılır ve veriyi görselleştirmek veya düzenlemek için
    //"render" özelliği ile birlikte kullanılabilir.
    {
      title: "Ürün Görseli",
      dataIndex: "img",
      width: "4%",
